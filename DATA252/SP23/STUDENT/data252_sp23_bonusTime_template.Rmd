...
#Fitting auto.arima ()
fit1 <- auto.arima(##YOUR CODE HERE ##) 
fit1
...
```{r}
#Fitting auto.arima ()
fit2 <- auto.arima(##YOUR CODE HERE ##) 
fit2
...
flu_ts <- ts(##YOUR CODE HERE ##)

plot(stl(##YOUR CODE HERE ##))
