...
## SAMPLE INDECES
sample0<-### YOUR CODE HERE ###
sample1<-### YOUR CODE HERE ###
...
set.seed(314)
caretSamp <- createDataPartition(### YOUR CODE HERE ###
...
trainFea<-### YOUR CODE HERE ###

testFea<-### YOUR CODE HERE ###

trainOut<-### YOUR CODE HERE ###
testOut<-### YOUR CODE HERE ###
```
...
setosa<- ### YOUR CODE HERE ###

versicolor<- ### YOUR CODE HERE ###

virginica<- ### YOUR CODE HERE ###

# 50 observations from each
# Take 60% to train (30) and 40% to test (20)
train <- sample### YOUR CODE HERE ###
